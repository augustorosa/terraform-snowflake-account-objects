...
Create your release tag following semantic versioning:
...
git commit -m "feat: v0.6.0 - major refactoring, provider 2.11.0, security enhancements"
...
**Important**: The tag MUST follow semantic versioning format (e.g., `v0.6.0`, `v1.0.0`, etc.)
...
3. Choose tag `v0.6.0`
4. Add release title: `v0.6.0 - Major Refactoring & Security Enhancements`
...
- [ ] Fix repository name typo (if needed)
...
git commit -m "feat: v0.6.0 - provider 2.11.0, central settings db, auto-tagging, security enhancements, file reorganization"
