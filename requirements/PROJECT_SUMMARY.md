...
- ANALYZE: Business-ready analytics
...
### Data Flow
```
External Sources → RAW Layer → PREPARE Layer → ANALYZE Layer → Business Users
                    ↑             ↑               ↑
